...
public class TrailRenderer2D : MonoBehaviour
{
    ...
    public float widthEnd = 0.5f;                   //the ending width of the trail
    ...
    public GameObject trail;//the right vertices derived from the center positions
